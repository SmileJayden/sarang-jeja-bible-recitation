...
const CORINTHIANS2_5_17: IVerse = {
  book: "고린도후서",
  chapter: "5",
  verse: "17",
  contents:
...
const PHILIPPIANS_4_6_7: IVerse = {
  book: "빌립보서",
  chapter: "4",
  verse: "6,7",
  contents:
...
const MATTEW_18_20: IVerse = {
  book: "마태복음",
  chapter: "18",
  verse: "20",
  contents: "두세 사람이 내 이름으로 모인 곳에는 나도 그들 중에 있느니라",
  semester: 0,
  week: 0,
  group: "교제",
};

const HEBREWS_10_24_25: IVerse = {
  book: "히브리서",
  chapter: "10",
  verse: "24,25",
  contents:
...
// 72 말씀 구절 - B. 그리스도를 전파함
const ISAIAH_53_6: IVerse = {
  book: "이사야",
  chapter: "53",
  verse: "6",
  contents:
...
// 72 말씀 구절 - C. 하나님을 의뢰함
const CORINTHIANS1_3_16: IVerse = {
  book: "고린도전서",
  chapter: "3",
  verse: "16",
  contents:
...
const CORINTHIANS1_2_12: IVerse = {
  book: "고린도전서",
  chapter: "2",
  verse: "12",
  contents:
    "우리가 세상의 영을 받지 아니하고 오직 하나님으로부터 온 영을 받았으니 이는 우리로 하여금 하나님께서 우리에게 은혜로 주신 것들을 알게하려 하심이라",
  semester: 0,
  week: 0,
  group: "성령",
};

const ISAIAH_41_10: IVerse = {
  book: "이사야",
  chapter: "41",
  verse: "10",
  contents:
...
const PHILIPPIANS_4_13: IVerse = {
  book: "빌립보서",
  chapter: "4",
  verse: "13",
  contents: "내게 능력 주시는 자 안에서 내가 모든 것을 할 수 있느니라",
  semester: 0,
  week: 0,
  group: "능력",
};

const LAMENTATIONS_3_22_23: IVerse = {
  book: "예레미야애가",
  chapter: "3",
  verse: "22,23",
  contents:
...
const PETER1_5_7: IVerse = {
  book: "베드로전서",
  chapter: "5",
  verse: "7",
  contents: "너희 염려를 다 주께 맡기라 이는 그가 너희를 돌보심이라",
  semester: 0,
  week: 0,
  group: "평안",
};

const ROMANS_8_32: IVerse = {
  book: "로마서",
  chapter: "8",
  verse: "32",
  contents:
...
// 72 말씀 구절 - D. 그리스도 제자의 자격
const MATTEW_6_33: IVerse = {
  book: "마태복음",
  chapter: "6",
  verse: "33",
  contents:
...
const CORINTHIANS1_15_58: IVerse = {
  book: "고린도전서",
  chapter: "15",
  verse: "58",
  contents:
...
const CORINTHIANS2_9_6_7: IVerse = {
  book: "고린도후서",
  chapter: "9",
  verse: "6,7",
  contents:
...
const PHILIPPIANS_2_3_4: IVerse = {
  book: "빌립보서",
  chapter: "2",
  verse: "3,4",
  contents:
...
const LEVITICUS_19_11: IVerse = {
  book: "레위기",
  chapter: "19",
  verse: "11",
  contents: "너희는 도둑질하지 말며 속이지 말며 서로 거짓말하지 말며",
  semester: 0,
  week: 0,
  group: "정직",
};

const ACTS_24_16: IVerse = {
  book: "사도행전",
  chapter: "24",
  verse: "16",
  contents:
...
const CORINTHIANS2_10_5: IVerse = {
  book: "고린도후서",
  chapter: "10",
  verse: "5",
  contents:
...
const CORINTHIANS2_5_10: IVerse = {
  book: "고린도후서",
  chapter: "5",
  verse: "10",
  contents:
...
const PHILIPPIANS_2_13_14: IVerse = {
  book: "빌립보서",
  chapter: "2",
  verse: "13,14",
  contents:
...
const COLOSSIANS_1_28_29: IVerse = {
  book: "골로새서",
  chapter: "1",
  verse: "28,29",
  contents:
